...
import com.game.roomdatabasedemoapplication.databinding.ActivityMainBinding
import com.game.roomdatabasedemoapplication.databinding.DialogUpdateBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun addRecord(employeeDao: EmployeeDao) {
        ...
        if (name.isNotEmpty() && email.isNotEmpty()) {
            lifecycleScope.launch {
                employeeDao.insert(EmployeeEntity(name = name, emailId = email))
            ...
            Toast.makeText(
                applicationContext,
                "Name or Email cannot be blank", Toast.LENGTH_SHORT
            ).show()
        }
    }
        ...
        lifecycleScope.launch {
            employeeDao.fetchAllEmployeeById(id).collect() {
                if(it != null) {
                    ...
                    binding.etUpdateEmailId.setText(it.emailId)
                }
            }
        }
